...
const fr = {
  ...
  b2b: {
    ...
    title: "Distributeurs, importateurs et marque de distributeur.",
    lead: "CARTHÉA s'adresse aux professionnels de l'agroalimentaire, en Europe et à l'international : distribution, épicerie fine, restauration, et production sous marque de distributeur.",
    items: [
      {
      ...
      },
      {
        ...
        desc: "Votre marque sur nos conditionnements : nous prenons en charge le produit, le conditionnement et l'étiquetage à vos couleurs.",
      },
      {
        title: "Documents & échantillons",
        desc: "Fiches techniques par format, spécifications d'étiquetage et échantillons disponibles sur demande.",
      },
    ],
    note: "MOQ, Incoterms et délais communiqués sur demande.",
    cta: "Demande professionnelle",
  },
  explorer: {
    stepLabel: "Étiquette",
    stepFormat: "Format",
  ...
  footer: {
    ...
    write: "Écrire",
    follow: "Suivre",
    rights: "© 2026 CARTHÉA Tunisie. Tous droits réservés.",
...
const en: Dict = {
  ...
  footer: {
    ...
    write: "Write",
    follow: "Follow",
    rights: "© 2026 CARTHÉA Tunisia. All rights reserved.",
...
const ar: Dict = {
  ...
  b2b: {
    label: "للمحترفين",
    title: "الموزّعون والمستوردون والعلامة الخاصة.",
    lead: "تتوجّه CARTHÉA إلى محترفي القطاع الغذائي في أوروبا وخارجها: التوزيع، متاجر الأطعمة الراقية، المطاعم، والإنتاج تحت العلامة الخاصة.",
    items: [
      {
      ...
      },
      {
        ...
        desc: "علامتكم على عبواتنا: نتكفّل بالزيت والتعبئة والملصقات بألوانكم.",
      },
      {
        title: "الوثائق والعيّنات",
        desc: "بطاقات تقنية لكل عبوة، مواصفات الملصقات وعيّنات عند الطلب.",
      },
    ],
    note: "الكمية الدنيا للطلب وشروط التسليم (Incoterms) والآجال تُقدَّم عند الطلب.",
    cta: "طلب احترافي",
  },
  explorer: {
    stepLabel: "الملصق",
  ...
  footer: {
    ...
    write: "راسلنا",
    follow: "تابعنا",
    rights: "© 2026 CARTHÉA تونس. جميع الحقوق محفوظة.",
    origin: "منتج تونسي",
  },
  contact: {
    label: "اتصل بنا",
